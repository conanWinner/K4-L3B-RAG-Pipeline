# PUBG: BATTLEGROUNDS Terms of Service

- **Source:** https://pubg.com/en/clause/term_of_service/label_steam/latest
- **Crawled:** 2026-09-25T03:05:52.731281+00:00

---

Effective Date: January 7, 2026

These Terms of Service (the “Terms”) applies to each of PUBG: BATTLEGROUNDS (each, the “Game”).

The Game comprises the video game software (the “Game Software”), the associated media, any software associated with the online mode of the video game (subject to any additional terms of service applicable to such online mode), any printed materials, manuals, any online or electronic documentation, and any and all copies of such software and materials (together, the “Game”) developed by KRAFTON, Inc. (“Company”, “we”, “our,” or “us”), which is located at 28~35F, 231, Teheran-ro, Gangnam-gu, Seoul, Republic of Korea. Company provides game services, the official community website, and other game related services (Collectively, the “Service(s)”).

“User”, “you”, or “player” means the person who uses the Game and/or Service and accepts and agrees to be bound and abide by these Terms by: (i) installing, copying or otherwise using the Game Software; (ii) using the Game; or (iii) using the Services. Depending on your country of residence, if you are below 18 years old and you choose to use the Service, we may ask consent from your parent or legal guardian.
...
IF YOU AGREE TO THE TERMS SET FORTH IN THIS AGREEMENT AND OUR PRIVACY POLICY, select “ACCEPT” to install the Game and to indicate your acceptance and understanding of these Terms and Privacy Policy.
...
(e) Company may also upgrade, change (including without limitation, from paid-to-play model ("P2P") to free-to-play model ("F2P")), or terminate the Game or Game Software or may discontinue offering either or both without notice to you. In the event the Game becomes F2P, users may access the Game for free but may need to use G-Coins to purchase and use certain paid contents within the Game.

(f) The company reserves the right to change, disable, replace or remove in-game items (e.g., weapons, cosmetics, skins, etc.) for any reason whatsoever within the sole discretion of the Company, including to account for changes to in-game content or to make balance adjustments.

3. Prohibited Uses

Company provides the Game and the Service to Users only for personal, non-commercial and entertainment purposes, as limited by these Terms. You agree not to violate any of these Terms. Violation of any of these Terms may lead to temporary or permanent suspension of any of your registration account that you create with us in relation to the Game and the Service (“Account”), your access to the Game, and/or your access to the Service, and some instances may also require an investigation by the Company, in accordance with these Terms. You agree to only use the Game and the Service, or any part of them, in a manner that is consistent with these Terms and the License and you SHALL NOT, AND NOT ATTEMPT TO:
...
(e) any information, data, facts, local files (such as Custom Game Mode files), or other content posted, distributed, or transmitted by the User or a third party in the Service or on the official website of the Company, including, but not limited to, their reliability, accuracy, security, functionality, confidentiality, or legality;
...
a) The Company may use the Privacy Policy and other policies to cover specific details that are not covered in these Terms in order to protect User interests and maintain order in the Game.
...
d) As noted in Section 3, some instances may require an investigation by the Company. You acknowledge and agree that, for the purpose of detecting, investigating, and enforcing violations, including specifically violations of Section 3(v), the Company may collect, record, access, process, convert, and retain interactions and communications by Users reasonably detected as potentially engaging in such conduct, including in-game chat or other social features, including but not limited to text, voice, Text-to-Speech ("TTS") or Speech-to-Text ("STT")converted text within the Game, or other in-game communication methods (“Communication Data”). The Company reserves the right to collect, record, access, process, convert, and retain Communication Data when reasonably necessary to resolve user disputes or inquiries, investigate reports or complaints, enforce these Terms, the Rules of Conduct, or other agreements or terms applicable to your use of the Game or the Service, prevent fraud, misconduct, harassment, or other disruptive behavior, or to maintain the safety, fairness, and integrity of the Game and its community. The specific scope, retention period, and processing methods for such Communication Data may be further described by the Company’s Privacy Policy
